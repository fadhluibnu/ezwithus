...
const SectionOne = () => {
  return (
    <>
      <section className="w-100 px-4 py-5 lg:py-8 lg:px-[75px] lg:mt-1 xl:mt-6 grid md:grid-cols-2 items-center">
        <div className="flex flex-col gap-9 xl:max-w-[524px]">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="font-['ClashDisplay-Semibold'] text-5xl lg:text-7xl">Make Projects <span className="bg-gradient-to-br from-[#9C2CF4] to-[#2C57F4] text-transparent bg-clip-text">Easy With Us</span>.</h1>
      ...
      <div className='absolute top-[0] overflow-hidden -z-50'>
        <img className='relative sm:hidden top-0 start-28 -z-50' src="/assets/image-one.webp" alt="image section 1" />
        <img className='absolute sm:hidden top-0 -z-10' src="/assets/background-section-one.webp" alt="background section one" />
      </div>
    </>
  )
}
// background="bg-[#080C2E]" titleColor="text-white" descColor="text-stone-200" colorListBenefit="text-white" iconColor="stroke-white" priceColor='text-white'
const PLANS = [
  {
    title: "Basic",
...
const SectionTwo = () => {
  return (
    <section className="w-100 px-4 py-5 lg:py-8 lg:px-[75px] md:mt-5 lg:mt-1 xl:mt-6">
      <div className='flex flex-col gap-2.5 items-center'>
        <h1 className='font-["ClashDisplay-Semibold"] text-2xl md:text-4xl lg:text-5xl lg:text-center'>Layanan Kami, Jasa Pembuatan Website</h1>
        <p className='text-seccondary text-sm md:font-medium md:text-base lg:max-w-xl lg:text-center'>Dengan layanan berikut. Kami akan bangun proyek dengan cepat dan berkualitas untuk tugas, kepentinggan atau bisnis Anda</p>
      </div>
