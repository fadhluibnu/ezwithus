...
const PriceCard = ({
  ...
  return (
    <div
      className={`w-100 flex flex-col gap-8 py-8 px-7 ${background} rounded-3xl`}
    >
      <svg
        width='46'
        height='46'
